...
If for some reason this doesn't work, you can go to <a href="https://quicksync.io/networks/osmosis.html" target="_blank">https://quicksync.io/networks/osmosis.html</a>, where you can copy the appropriate donwnload link and set $URL. now you can run `cd $HOME/.osmosisd && wget -O - $URL | lz4 -d | tar -xvf -`
